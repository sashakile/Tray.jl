...
- Validate exact primitive rules and domain-neutral built-in and user-defined payload baselines (REQ-A6).
...
- **Affected tests**: algebra laws, rules, provider matrix, artifact invalidation, analysis coverage, domain-neutral payload baselines, and atomic update fallback.

## Dependencies
- Lawful `combine` operations and ancestor-path update infrastructure remain authoritative for arbitrary payload types.
