...
# ---------------------------------------------------------------------------
# REQ-21: Sketch compression is deferred
# ---------------------------------------------------------------------------
#
# Sketch compression (HistogramSketch, CompressedSamplePayload, etc.) has
# been deferred until a pairing-preserving compressed representation is
# approved. See defer-nonconforming-sample-compression.
#
# Exact aligned sample vectors are the only conforming REQ-21
# representation in the current release.
