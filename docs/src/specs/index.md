...
navigation includes project conventions and all currently present active changes,
proposals, design decisions, implementation tasks, and capability specifications.
Archived changes will appear automatically after the first change is archived.
